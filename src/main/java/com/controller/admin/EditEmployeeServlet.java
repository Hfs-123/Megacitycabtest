...
public class EditEmployeeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (isUpdated) {
            response.sendRedirect("Employee.jsp?success=Employee updated successfully!");
        } else {
            response.sendRedirect("Editusers.jsp?id=" + employeeId + "&error=Update failed. Try again.");
        }
    }
}
