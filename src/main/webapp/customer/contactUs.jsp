...
<body>
	...
	<div class="container">
		...
		if ("1".equals(success)) {
		%>
		<div class="alert alert-success text-center">Your message has
			been sent successfully!</div>
		<%
		} else if ("1".equals(error)) {
		%>
		<div class="alert alert-danger text-center">Failed to send
			message. Please try again.</div>
		<%
		}
		%>
		...
		<div class="contact-container">
			...
			<form action="SendInquiryServlet" method="post">
				...
				<button type="submit" class="btn btn-primary w-100 mb-2">Send
					Message</button>
			</form>

			<!-- New "View Replies" Button -->
			<a href="viewReplies.jsp" class="btn btn-secondary w-100">View My
				Replies</a>
		</div>
	</div>
