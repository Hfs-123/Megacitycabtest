...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/Main_css/customer/View.css">
</head>
<body>
...
<div class="main-content">
    ...
    <div class="container mt-5">
        ...
        BookingDAO ReseravtionDAO = new BookingDAO();
                            List<Booking> bookings = ReseravtionDAO.getAllBookings();
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <% if ("Cancelled by Staff".equalsIgnoreCase(booking.getStatus())) { %>
                                <span class="badge bg-danger">Cancelled by Staff</span>
                            <% } else { %>
