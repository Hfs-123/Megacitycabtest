...
<%@ page import="com.dao.customer.BillingDAO,com.model.customer.Billing,java.util.List" %>
<%
...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/Main_css/customer/bill.css">
</head>
<body>
        ...
        %>
            <div class="card mt-4">
                <div class="card-body">
                    ...
                    <% } else if ("Awaiting Staff Approval".equals(bill.getPaymentStatus())) { %>
                        <p class="text-danger">Waiting for Staff Approval</p>
                    <% } %>
                </div>
            </div>
        <% } else { %>
